...
const CreatePost = () => {
  ...
  const [models, setModels] = useState(['stable-diffusion', 'Mann-E_Dreams'])
  ...
  const generateImage = async () => {
    ...
    if (form.prompt && form.model) {
      ...
      try {
        ...
        if (form.model == "stable-diffusion") {
        ...
        else if(form.model == "Mann-E_Dreams"){
    ...
    <>
     ...
     <section className="max-w-7xl mx-auto ">
        ...
        <div className=' mb-3'>
          ...
          <p className="mt-2 text-[#666e75] text-lg max-w-[500px]">Create imaginative and visually stunning images through Open Source AI and share them with the community</p>
        </div>
            ...
            <div className='flex flex-col bg-lime-300 p-6 gap-2  text-black rounded-md'>
              ...
              <div className='flex flex-col lg:flex-row gap-4'>
                <div className='  mt-1 border border-black p-2'>
                  <h2 className=' font-medium'>stable-diffusion-xl-base</h2>
                  <p>
                    This is a lighter model, hence generates output comparitively faster but compromises on quality of the image.
                  </p>
                </div>
                <div className=' mt-1 border border-black p-2'>
                  <h2 className=' font-medium'>Mann-E_Dreams</h2>
                  <p>
                  From Mann-E this model used thousands of midjourney generated images in order to make it possible to make high-quality images.
                  </p>
                </div>
              </div>
